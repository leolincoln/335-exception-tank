...
public class NetWorkEnemyProjectile extends Observable  implements Projectile {
	...
	private NetWorkEnemyProjectile thisMissle;
	...
	public NetWorkEnemyProjectile(Point p, int x, int y, PlayerTank t, Map map) {
		this.p = p;
		speed = 20;
		this.map = map;
		this.xspeed = x;
