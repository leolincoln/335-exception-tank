...
public class NetworkTankView extends MasterViewPanel implements Observer {
	...
	public NetworkTankView(MasterView m, int i) {
		...
		model.getMap().enemyList.getFirst().startEnemyTank();
	...
	public void paintComponent(Graphics g) {
		...
		itemList=model.getMap().getItems();
		tankList = model.map.getPlayers();
		enemyList = model.getMap().getEnemies();
		projectileList = model.getMap().getProjectiles();
		explosionList = model.getMap().getExplosions();
		...
		String curr = "Current Level: " + model.getMap().getLevelNumber();
